...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TVAViews'
        db.create_table(u'accounting_core_tvaviews', (
            ...
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='views', to=orm['accounting_core.TVA'])),
        ))
        db.send_create_signal(u'accounting_core', ['TVAViews'])

        # Adding model 'CostCenterViews'
        db.create_table(u'accounting_core_costcenterviews', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('who', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.TruffeUser'])),
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='views', to=orm['accounting_core.CostCenter'])),
        ))
        db.send_create_signal(u'accounting_core', ['CostCenterViews'])

        # Adding model 'AccountCategoryViews'
        db.create_table(u'accounting_core_accountcategoryviews', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('who', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.TruffeUser'])),
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='views', to=orm['accounting_core.AccountCategory'])),
        ))
        db.send_create_signal(u'accounting_core', ['AccountCategoryViews'])

        # Adding model 'AccountingYearViews'
        db.create_table(u'accounting_core_accountingyearviews', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('who', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.TruffeUser'])),
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='views', to=orm['accounting_core.AccountingYear'])),
        ))
        db.send_create_signal(u'accounting_core', ['AccountingYearViews'])

        # Adding model 'AccountViews'
        db.create_table(u'accounting_core_accountviews', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('who', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.TruffeUser'])),
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='views', to=orm['accounting_core.Account'])),
        ))
        db.send_create_signal(u'accounting_core', ['AccountViews'])


    def backwards(self, orm):
        # Deleting model 'TVAViews'
        db.delete_table(u'accounting_core_tvaviews')

        # Deleting model 'CostCenterViews'
        db.delete_table(u'accounting_core_costcenterviews')

        # Deleting model 'AccountCategoryViews'
        db.delete_table(u'accounting_core_accountcategoryviews')

        # Deleting model 'AccountingYearViews'
        db.delete_table(u'accounting_core_accountingyearviews')

        # Deleting model 'AccountViews'
        db.delete_table(u'accounting_core_accountviews')
