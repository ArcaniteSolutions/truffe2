...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CostCenterLogging'
        db.create_table(u'accounting_core_costcenterlogging', (
            ...
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='logs', to=orm['accounting_core.CostCenter'])),
        ))
        db.send_create_signal(u'accounting_core', ['CostCenterLogging'])

        # Adding model 'CostCenter'
        db.create_table(u'accounting_core_costcenter', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'accounting_core', ['CostCenter'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'CostCenterLogging'
        db.delete_table(u'accounting_core_costcenterlogging')

        # Deleting model 'CostCenter'
        db.delete_table(u'accounting_core_costcenter')
