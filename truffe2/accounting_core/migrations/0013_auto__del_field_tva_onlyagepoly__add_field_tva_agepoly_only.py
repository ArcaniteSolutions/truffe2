...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TVA.onlyagepoly'
        db.delete_column(u'accounting_core_tva', 'onlyagepoly')

        # Adding field 'TVA.agepoly_only'
        db.add_column(u'accounting_core_tva', 'agepoly_only',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TVA.onlyagepoly'
        db.add_column(u'accounting_core_tva', 'onlyagepoly',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'TVA.agepoly_only'
        db.delete_column(u'accounting_core_tva', 'agepoly_only')
