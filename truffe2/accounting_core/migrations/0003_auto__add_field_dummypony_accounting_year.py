...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DummyPony.accounting_year'
        db.add_column(u'accounting_core_dummypony', 'accounting_year',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounting_core.AccountingYear']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DummyPony.accounting_year'
        db.delete_column(u'accounting_core_dummypony', 'accounting_year_id')
