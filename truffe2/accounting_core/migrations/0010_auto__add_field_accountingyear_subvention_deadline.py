...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccountingYear.subvention_deadline'
        db.add_column(u'accounting_core_accountingyear', 'subvention_deadline',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AccountingYear.subvention_deadline'
        db.delete_column(u'accounting_core_accountingyear', 'subvention_deadline')
