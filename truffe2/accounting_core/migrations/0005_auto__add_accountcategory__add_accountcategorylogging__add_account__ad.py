...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AccountCategory'
        db.create_table(u'accounting_core_accountcategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('parent_hierarchique', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounting_core.AccountCategory'], null=True, blank=True)),
            ('accounting_year', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounting_core.AccountingYear'])),
        ))
        db.send_create_signal(u'accounting_core', ['AccountCategory'])

        # Adding model 'AccountCategoryLogging'
        db.create_table(u'accounting_core_accountcategorylogging', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='logs', to=orm['accounting_core.AccountCategory'])),
        ))
        db.send_create_signal(u'accounting_core', ['AccountCategoryLogging'])

        # Adding model 'Account'
        db.create_table(u'accounting_core_account', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('account_number', self.gf('django.db.models.fields.SmallIntegerField')(unique=True)),
            ('visibility', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('accounting_year', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounting_core.AccountingYear'])),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounting_core.AccountCategory'])),
        ))
        db.send_create_signal(u'accounting_core', ['Account'])

        # Adding model 'AccountLogging'
        db.create_table(u'accounting_core_accountlogging', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('extra_data', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('who', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.TruffeUser'])),
            ('what', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='logs', to=orm['accounting_core.Account'])),
        ))
        db.send_create_signal(u'accounting_core', ['AccountLogging'])


    def backwards(self, orm):
        # Deleting model 'AccountCategory'
        db.delete_table(u'accounting_core_accountcategory')

        # Deleting model 'AccountCategoryLogging'
        db.delete_table(u'accounting_core_accountcategorylogging')

        # Deleting model 'Account'
        db.delete_table(u'accounting_core_account')

        # Deleting model 'AccountLogging'
        db.delete_table(u'accounting_core_accountlogging')


    models = {
        u'accounting_core.account': {
            'Meta': {'object_name': 'Account'},
            'account_number': ('django.db.models.fields.SmallIntegerField', [], {'unique': 'True'}),
        ...
        u'accounting_core.accountcategory': {
            'Meta': {'object_name': 'AccountCategory'},
            'accounting_year': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounting_core.AccountingYear']"}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
