...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'accounting_core_account', ['name'])

        # Removing unique constraint on 'CostCenter', fields ['name']
        db.delete_unique(u'accounting_core_costcenter', ['name'])

        # Adding unique constraint on 'CostCenter', fields ['name', 'accounting_year']
        db.create_unique(u'accounting_core_costcenter', ['name', 'accounting_year_id'])

        # Adding unique constraint on 'Account', fields ['name', 'accounting_year']
        db.create_unique(u'accounting_core_account', ['name', 'accounting_year_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Account', fields ['name', 'accounting_year']
        db.delete_unique(u'accounting_core_account', ['name', 'accounting_year_id'])

        # Removing unique constraint on 'CostCenter', fields ['name', 'accounting_year']
        db.delete_unique(u'accounting_core_costcenter', ['name', 'accounting_year_id'])

        # Adding unique constraint on 'CostCenter', fields ['name']
        db.create_unique(u'accounting_core_costcenter', ['name'])

        # Adding unique constraint on 'Account', fields ['name']
        db.create_unique(u'accounting_core_account', ['name'])


    models = {
        u'accounting_core.account': {
            'Meta': {'unique_together': "(('name', 'accounting_year'),)", 'object_name': 'Account'},
        ...
        u'accounting_core.costcenter': {
            'Meta': {'unique_together': "(('name', 'accounting_year'),)", 'object_name': 'CostCenter'},
            'account_number': ('django.db.models.fields.SmallIntegerField', [], {'unique': 'True'}),
            'accounting_year': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accounting_core.AccountingYear']"}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
