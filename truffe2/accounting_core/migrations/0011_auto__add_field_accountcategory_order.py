...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccountCategory.order'
        db.add_column(u'accounting_core_accountcategory', 'order',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AccountCategory.order'
        db.delete_column(u'accounting_core_accountcategory', 'order')
