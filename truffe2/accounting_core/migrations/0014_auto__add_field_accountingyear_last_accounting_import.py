...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccountingYear.last_accounting_import'
        db.add_column(u'accounting_core_accountingyear', 'last_accounting_import',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AccountingYear.last_accounting_import'
        db.delete_column(u'accounting_core_accountingyear', 'last_accounting_import')
