...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TVALogging'
        db.create_table(u'accounting_core_tvalogging', (
            ...
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='logs', to=orm['accounting_core.TVA'])),
        ))
        db.send_create_signal(u'accounting_core', ['TVALogging'])

        # Adding model 'TVA'
        db.create_table(u'accounting_core_tva', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('value', self.gf('django.db.models.fields.DecimalField')(max_digits=20, decimal_places=2)),
            ('onlyagepoly', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'accounting_core', ['TVA'])


    def backwards(self, orm):
        # Deleting model 'TVALogging'
        db.delete_table(u'accounting_core_tvalogging')

        # Deleting model 'TVA'
        db.delete_table(u'accounting_core_tva')
    ...
    models = {
        ...
        u'accounting_core.tva': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'onlyagepoly': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
