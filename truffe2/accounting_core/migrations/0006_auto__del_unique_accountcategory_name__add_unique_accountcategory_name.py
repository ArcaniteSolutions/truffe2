...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'AccountCategory', fields ['name']
        db.delete_unique(u'accounting_core_accountcategory', ['name'])

        # Adding unique constraint on 'AccountCategory', fields ['name', 'accounting_year']
        db.create_unique(u'accounting_core_accountcategory', ['name', 'accounting_year_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'AccountCategory', fields ['name', 'accounting_year']
        db.delete_unique(u'accounting_core_accountcategory', ['name', 'accounting_year_id'])

        # Adding unique constraint on 'AccountCategory', fields ['name']
        db.create_unique(u'accounting_core_accountcategory', ['name'])
