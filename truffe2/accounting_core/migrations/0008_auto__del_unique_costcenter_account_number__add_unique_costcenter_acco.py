...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Account', fields ['account_number']
        db.delete_unique(u'accounting_core_account', ['account_number'])

        # Removing unique constraint on 'CostCenter', fields ['account_number']
        db.delete_unique(u'accounting_core_costcenter', ['account_number'])

        # Adding unique constraint on 'CostCenter', fields ['account_number', 'accounting_year']
        db.create_unique(u'accounting_core_costcenter', ['account_number', 'accounting_year_id'])

        # Adding unique constraint on 'Account', fields ['account_number', 'accounting_year']
        db.create_unique(u'accounting_core_account', ['account_number', 'accounting_year_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Account', fields ['account_number', 'accounting_year']
        db.delete_unique(u'accounting_core_account', ['account_number', 'accounting_year_id'])

        # Removing unique constraint on 'CostCenter', fields ['account_number', 'accounting_year']
        db.delete_unique(u'accounting_core_costcenter', ['account_number', 'accounting_year_id'])

        # Adding unique constraint on 'CostCenter', fields ['account_number']
        db.create_unique(u'accounting_core_costcenter', ['account_number'])

        # Adding unique constraint on 'Account', fields ['account_number']
        db.create_unique(u'accounting_core_account', ['account_number'])


    models = {
        u'accounting_core.account': {
            'Meta': {'unique_together': "(('name', 'accounting_year'), ('account_number', 'accounting_year'))", 'object_name': 'Account'},
            'account_number': ('django.db.models.fields.SmallIntegerField', [], {}),
