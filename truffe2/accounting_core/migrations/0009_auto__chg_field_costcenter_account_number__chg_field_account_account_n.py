...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'accounting_core_costcenter', 'account_number', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Account.account_number'
        db.alter_column(u'accounting_core_account', 'account_number', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):

        # Changing field 'CostCenter.account_number'
        db.alter_column(u'accounting_core_costcenter', 'account_number', self.gf('django.db.models.fields.SmallIntegerField')())

        # Changing field 'Account.account_number'
        db.alter_column(u'accounting_core_account', 'account_number', self.gf('django.db.models.fields.SmallIntegerField')())
