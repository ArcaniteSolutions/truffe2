...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column(u'units_unit', 'parent_herachique_id', 'parent_hierarchique_id')


    def backwards(self, orm):
        # Renaming field 'Unit.parent_herachique'
        db.rename_column(u'units_unit', 'parent_hierarchique_id', 'parent_herachique_id')
