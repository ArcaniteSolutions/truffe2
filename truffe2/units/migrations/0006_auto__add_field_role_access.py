...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Role.access'
        db.add_column(u'units_role', 'access',
                      self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=71, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Role.access'
        db.delete_column(u'units_role', 'access')
    ...
    models = {
        ...
        u'units.accreditation': {
            ...
            'unite': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['units.Unit']"}),
