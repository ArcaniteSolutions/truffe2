...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Role.access'
        db.alter_column(u'units_role', 'access', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=71, null=True))

        # Changing field 'AccessDelegation.access'
        db.alter_column(u'units_accessdelegation', 'access', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=71, null=True))
    ...
    models = {
        ...
        u'units.accessdelegation': {
            ...
            'access': ('multiselectfield.db.fields.MultiSelectField', [], {'max_length': '85', 'null': 'True', 'blank': 'True'}),
