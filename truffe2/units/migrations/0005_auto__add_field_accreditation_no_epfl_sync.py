...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Accreditation.no_epfl_sync'
        db.add_column(u'units_accreditation', 'no_epfl_sync',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Accreditation.no_epfl_sync'
        db.delete_column(u'units_accreditation', 'no_epfl_sync')
