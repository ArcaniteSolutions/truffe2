...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Accreditation.hidden_in_epfl'
        db.add_column(u'units_accreditation', 'hidden_in_epfl',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Accreditation.hidden_in_truffe'
        db.add_column(u'units_accreditation', 'hidden_in_truffe',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Accreditation.hidden_in_epfl'
        db.delete_column(u'units_accreditation', 'hidden_in_epfl')

        # Deleting field 'Accreditation.hidden_in_truffe'
        db.delete_column(u'units_accreditation', 'hidden_in_truffe')
