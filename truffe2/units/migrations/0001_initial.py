...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'units_unit', (
            ...
            ('id_epfl', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('is_commission', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('is_equipe', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('parent_herachique', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['units.Unit'], null=True, blank=True)),
        ))
        db.send_create_signal(u'units', ['Unit'])

        # Adding model 'UnitLogging'
        db.create_table(u'units_unitlogging', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='logs', to=orm['units.Unit'])),
        ))
        db.send_create_signal(u'units', ['UnitLogging'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'UnitLogging'
        db.delete_table(u'units_unitlogging')
