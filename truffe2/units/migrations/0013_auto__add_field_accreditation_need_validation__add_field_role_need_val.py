...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Accreditation.need_validation'
        db.add_column(u'units_accreditation', 'need_validation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Role.need_validation'
        db.add_column(u'units_role', 'need_validation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Accreditation.need_validation'
        db.delete_column(u'units_accreditation', 'need_validation')

        # Deleting field 'Role.need_validation'
        db.delete_column(u'units_role', 'need_validation')
