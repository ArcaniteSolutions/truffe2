...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Role.access'
        db.alter_column(u'units_role', 'access', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=97, null=True))

        # Changing field 'AccessDelegation.access'
        db.alter_column(u'units_accessdelegation', 'access', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=97, null=True))

    def backwards(self, orm):

        # Changing field 'Role.access'
        db.alter_column(u'units_role', 'access', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=85, null=True))

        # Changing field 'AccessDelegation.access'
        db.alter_column(u'units_accessdelegation', 'access', self.gf('multiselectfield.db.fields.MultiSelectField')(max_length=85, null=True))
