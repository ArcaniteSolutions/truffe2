...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Role'
        db.create_table(u'units_role', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('id_epfl', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('ordre', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'units', ['Role'])

        # Adding model 'RoleLogging'
        db.create_table(u'units_rolelogging', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='logs', to=orm['units.Role'])),
        ))
        db.send_create_signal(u'units', ['RoleLogging'])


    def backwards(self, orm):
        # Deleting model 'Role'
        db.delete_table(u'units_role')

        # Deleting model 'RoleLogging'
        db.delete_table(u'units_rolelogging')
