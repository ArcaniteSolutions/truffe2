...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AccreditationLog'
        db.create_table(u'units_accreditationlog', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('accreditation', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['units.Accreditation'])),
            ...
            ('what', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=32)),
        ))
        db.send_create_signal(u'units', ['AccreditationLog'])


    def backwards(self, orm):
        # Deleting model 'AccreditationLog'
        db.delete_table(u'units_accreditationlog')
