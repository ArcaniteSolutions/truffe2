...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Room.max_days'
        db.add_column(u'logistics_room', 'max_days',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Room.max_days_externals'
        db.add_column(u'logistics_room', 'max_days_externals',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Room.minimum_days_before'
        db.add_column(u'logistics_room', 'minimum_days_before',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Room.minimum_days_before_externals'
        db.add_column(u'logistics_room', 'minimum_days_before_externals',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Room.maximum_days_before'
        db.add_column(u'logistics_room', 'maximum_days_before',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Room.maximum_days_before_externals'
        db.add_column(u'logistics_room', 'maximum_days_before_externals',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Room.max_days'
        db.delete_column(u'logistics_room', 'max_days')

        # Deleting field 'Room.max_days_externals'
        db.delete_column(u'logistics_room', 'max_days_externals')

        # Deleting field 'Room.minimum_days_before'
        db.delete_column(u'logistics_room', 'minimum_days_before')

        # Deleting field 'Room.minimum_days_before_externals'
        db.delete_column(u'logistics_room', 'minimum_days_before_externals')

        # Deleting field 'Room.maximum_days_before'
        db.delete_column(u'logistics_room', 'maximum_days_before')

        # Deleting field 'Room.maximum_days_before_externals'
        db.delete_column(u'logistics_room', 'maximum_days_before_externals')
    ...
    models = {
        ...
        u'logistics.room': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'max_days': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'max_days_externals': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'maximum_days_before': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'maximum_days_before_externals': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'minimum_days_before': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'minimum_days_before_externals': ('django.db.models.fields.PositiveIntegerField', [], {}),
