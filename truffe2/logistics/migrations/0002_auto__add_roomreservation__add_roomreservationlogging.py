...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RoomReservation'
        db.create_table(u'logistics_roomreservation', (
            ...
            ('unit_blank_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.TruffeUser'])),
            ('unit_blank_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('room', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['logistics.Room'])),
        ))
        db.send_create_signal(u'logistics', ['RoomReservation'])

        # Adding model 'RoomReservationLogging'
        db.create_table(u'logistics_roomreservationlogging', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='logs', to=orm['logistics.RoomReservation'])),
        ))
        db.send_create_signal(u'logistics', ['RoomReservationLogging'])


    def backwards(self, orm):
        # Deleting model 'RoomReservation'
        db.delete_table(u'logistics_roomreservation')

        # Deleting model 'RoomReservationLogging'
        db.delete_table(u'logistics_roomreservationlogging')
    ...
    models = {
        ...
        u'logistics.roomreservation': {
            ...
            'unit_blank_name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'unit_blank_user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.TruffeUser']"})
        },
