...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SupplyReservation.contact_phone'
        db.add_column(u'logistics_supplyreservation', 'contact_phone',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SupplyReservation.contact_phone'
        db.delete_column(u'logistics_supplyreservation', 'contact_phone')
