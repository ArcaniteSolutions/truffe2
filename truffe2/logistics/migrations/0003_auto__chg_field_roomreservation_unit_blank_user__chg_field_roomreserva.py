...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RoomReservation.unit_blank_user'
        db.alter_column(u'logistics_roomreservation', 'unit_blank_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.TruffeUser'], null=True))

        # Changing field 'RoomReservation.remarks'
        db.alter_column(u'logistics_roomreservation', 'remarks', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'RoomReservation.unit_blank_name'
        db.alter_column(u'logistics_roomreservation', 'unit_blank_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'RoomReservation.unit_blank_user'
        raise RuntimeError("Cannot reverse this migration. 'RoomReservation.unit_blank_user' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'RoomReservation.unit_blank_user'
        db.alter_column(u'logistics_roomreservation', 'unit_blank_user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.TruffeUser']))

        # User chose to not deal with backwards NULL issues for 'RoomReservation.remarks'
        raise RuntimeError("Cannot reverse this migration. 'RoomReservation.remarks' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'RoomReservation.remarks'
        db.alter_column(u'logistics_roomreservation', 'remarks', self.gf('django.db.models.fields.TextField')())

        # User chose to not deal with backwards NULL issues for 'RoomReservation.unit_blank_name'
        raise RuntimeError("Cannot reverse this migration. 'RoomReservation.unit_blank_name' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'RoomReservation.unit_blank_name'
        db.alter_column(u'logistics_roomreservation', 'unit_blank_name', self.gf('django.db.models.fields.CharField')(max_length=255))
