...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Room.allow_external_calendar'
        db.add_column(u'logistics_room', 'allow_external_calendar',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Supply.allow_external_calendar'
        db.add_column(u'logistics_supply', 'allow_external_calendar',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Room.allow_external_calendar'
        db.delete_column(u'logistics_room', 'allow_external_calendar')

        # Deleting field 'Supply.allow_external_calendar'
        db.delete_column(u'logistics_supply', 'allow_external_calendar')
