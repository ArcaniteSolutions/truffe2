...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SupplyReservationLine'
        db.create_table(u'logistics_supplyreservationline', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('order', self.gf('django.db.models.fields.SmallIntegerField')(default=0)),
            ('supply_reservation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lines', to=orm['logistics.SupplyReservation'])),
            ('quantity', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal(u'logistics', ['SupplyReservationLine'])


    def backwards(self, orm):
        # Deleting model 'SupplyReservationLine'
        db.delete_table(u'logistics_supplyreservationline')
