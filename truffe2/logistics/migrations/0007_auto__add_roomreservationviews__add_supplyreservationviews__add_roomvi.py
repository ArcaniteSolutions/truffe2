...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RoomReservationViews'
        db.create_table(u'logistics_roomreservationviews', (
            ...
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='views', to=orm['logistics.RoomReservation'])),
        ))
        db.send_create_signal(u'logistics', ['RoomReservationViews'])

        # Adding model 'SupplyReservationViews'
        db.create_table(u'logistics_supplyreservationviews', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('who', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.TruffeUser'])),
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='views', to=orm['logistics.SupplyReservation'])),
        ))
        db.send_create_signal(u'logistics', ['SupplyReservationViews'])

        # Adding model 'RoomViews'
        db.create_table(u'logistics_roomviews', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('who', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.TruffeUser'])),
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='views', to=orm['logistics.Room'])),
        ))
        db.send_create_signal(u'logistics', ['RoomViews'])

        # Adding model 'SupplyViews'
        db.create_table(u'logistics_supplyviews', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('who', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.TruffeUser'])),
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='views', to=orm['logistics.Supply'])),
        ))
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'SupplyReservationViews'
        db.delete_table(u'logistics_supplyreservationviews')

        # Deleting model 'RoomViews'
        db.delete_table(u'logistics_roomviews')
