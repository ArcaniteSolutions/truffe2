...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'logistics_supplyreservation', 'supply_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'SupplyReservation.supply'
        raise RuntimeError("Cannot reverse this migration. 'SupplyReservation.supply' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'SupplyReservation.supply'
        db.add_column(u'logistics_supplyreservation', 'supply',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['logistics.Supply']),
                      keep_default=False)
