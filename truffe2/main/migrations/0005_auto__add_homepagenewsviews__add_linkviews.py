...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HomePageNewsViews'
        db.create_table(u'main_homepagenewsviews', (
            ...
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='views', to=orm['main.HomePageNews'])),
        ))
        db.send_create_signal(u'main', ['HomePageNewsViews'])

        # Adding model 'LinkViews'
        db.create_table(u'main_linkviews', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('who', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.TruffeUser'])),
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='views', to=orm['main.Link'])),
        ))
        db.send_create_signal(u'main', ['LinkViews'])


    def backwards(self, orm):
        # Deleting model 'HomePageNewsViews'
        db.delete_table(u'main_homepagenewsviews')

        # Deleting model 'LinkViews'
        db.delete_table(u'main_linkviews')
