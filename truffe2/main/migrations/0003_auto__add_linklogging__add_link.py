...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LinkLogging'
        db.create_table(u'main_linklogging', (
            ...
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='logs', to=orm['main.Link'])),
        ))
        db.send_create_signal(u'main', ['LinkLogging'])
        ...
        db.create_table(u'main_link', (
            ...
            ('leftmenu', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('icon', self.gf('django.db.models.fields.CharField')(default='fa-external-link-square', max_length=128)),
        ))
        db.send_create_signal(u'main', ['Link'])


    def backwards(self, orm):
        # Deleting model 'LinkLogging'
        db.delete_table(u'main_linklogging')
