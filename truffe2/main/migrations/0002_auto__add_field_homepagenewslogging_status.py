...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomePageNewsLogging.status'
        db.add_column(u'main_homepagenewslogging', 'status',
                      self.gf('django.db.models.fields.CharField')(default='draft', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomePageNewsLogging.status'
        db.delete_column(u'main_homepagenewslogging', 'status')
