...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'vehicles_booking', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('responsible', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.TruffeUser'])),
            ('reason', self.gf('django.db.models.fields.TextField')()),
            ('remark', self.gf('django.db.models.fields.TextField')()),
            ('remark_agepoly', self.gf('django.db.models.fields.TextField')()),
            ('start_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('end_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('status', self.gf('django.db.models.fields.CharField')(default='0_draft', max_length=255)),
            ('card', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vehicles.Card'])),
            ('vehicletype', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vehicles.VehicleType'])),
            ('location', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vehicles.Location'])),
        ...
        db.send_create_signal(u'vehicles', ['Booking'])

        # Adding model 'BookingLogging'
        db.create_table(u'vehicles_bookinglogging', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='logs', to=orm['vehicles.Booking'])),
        ))
        db.send_create_signal(u'vehicles', ['BookingLogging'])


    def backwards(self, orm):
        # Deleting model 'Booking'
        db.delete_table(u'vehicles_booking')

        # Deleting model 'BookingLogging'
        db.delete_table(u'vehicles_bookinglogging')
    ...
    models = {
        ...
        u'vehicles.booking': {
            ...
            'card': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['vehicles.Card']"}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'end_date': ('django.db.models.fields.DateTimeField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'location': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['vehicles.Location']"}),
            ...
            'remark_agepoly': ('django.db.models.fields.TextField', [], {}),
        ...
        u'vehicles.location': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'url_location': ('django.db.models.fields.URLField', [], {'max_length': '200'})
        },
