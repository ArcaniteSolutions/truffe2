...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LocationLogging'
        db.create_table(u'vehicles_locationlogging', (
            ...
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='logs', to=orm['vehicles.Location'])),
        ))
        db.send_create_signal(u'vehicles', ['LocationLogging'])

        # Adding model 'Location'
        db.create_table(u'vehicles_location', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('url_location', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal(u'vehicles', ['Location'])


    def backwards(self, orm):
        # Deleting model 'LocationLogging'
        db.delete_table(u'vehicles_locationlogging')

        # Deleting model 'Location'
        db.delete_table(u'vehicles_location')
