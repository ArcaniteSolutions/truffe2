...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'vehicles_vehicletype', (
        ...
        db.send_create_signal(u'vehicles', ['VehicleType'])

        # Adding model 'VehicleTypeLogging'
        db.create_table(u'vehicles_vehicletypelogging', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='logs', to=orm['vehicles.VehicleType'])),
        ))
        db.send_create_signal(u'vehicles', ['VehicleTypeLogging'])


    def backwards(self, orm):
        # Deleting model 'VehicleType'
        db.delete_table(u'vehicles_vehicletype')

        # Deleting model 'VehicleTypeLogging'
        db.delete_table(u'vehicles_vehicletypelogging')
