...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.url_location'
        db.alter_column(u'vehicles_location', 'url_location', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Location.url_location'
        raise RuntimeError("Cannot reverse this migration. 'Location.url_location' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Location.url_location'
        db.alter_column(u'vehicles_location', 'url_location', self.gf('django.db.models.fields.URLField')(max_length=200))
