...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'MemberSet', fields ['name']
        db.delete_unique(u'members_memberset', ['name'])

        # Adding unique constraint on 'MemberSet', fields ['name', 'unit']
        db.create_unique(u'members_memberset', ['name', 'unit_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'MemberSet', fields ['name', 'unit']
        db.delete_unique(u'members_memberset', ['name', 'unit_id'])

        # Adding unique constraint on 'MemberSet', fields ['name']
        db.create_unique(u'members_memberset', ['name'])
