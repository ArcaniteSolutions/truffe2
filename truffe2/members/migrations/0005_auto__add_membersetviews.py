...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MemberSetViews'
        db.create_table(u'members_membersetviews', (
            ...
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='views', to=orm['members.MemberSet'])),
        ))
        db.send_create_signal(u'members', ['MemberSetViews'])


    def backwards(self, orm):
        # Deleting model 'MemberSetViews'
        db.delete_table(u'members_membersetviews')
    ...
    models = {
        ...
        u'members.memberset': {
            'Meta': {'unique_together': "(('name', 'unit'),)", 'object_name': 'MemberSet'},
        ...
        u'members.membersetviews': {
            'Meta': {'object_name': 'MemberSetViews'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'views'", 'to': u"orm['members.MemberSet']"}),
            'when': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'who': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.TruffeUser']"})
        },
