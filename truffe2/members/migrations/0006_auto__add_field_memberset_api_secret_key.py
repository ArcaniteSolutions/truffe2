...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MemberSet.api_secret_key'
        db.add_column(u'members_memberset', 'api_secret_key',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MemberSet.api_secret_key'
        db.delete_column(u'members_memberset', 'api_secret_key')
    ...
    models = {
        ...
        u'members.memberset': {
            ...
            'api_secret_key': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
