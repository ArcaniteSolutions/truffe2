...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Notification.species'
        db.add_column(u'notifications_notification', 'species',
                      self.gf('django.db.models.fields.CharField')(default='moderation', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Notification.species'
        db.delete_column(u'notifications_notification', 'species')
