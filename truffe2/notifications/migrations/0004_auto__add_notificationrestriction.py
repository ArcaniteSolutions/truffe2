...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NotificationRestriction'
        db.create_table(u'notifications_notificationrestriction', (
            ...
            ('autoread', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'notifications', ['NotificationRestriction'])


    def backwards(self, orm):
        # Deleting model 'NotificationRestriction'
        db.delete_table(u'notifications_notificationrestriction')
