...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Notification.title'
        db.delete_column(u'notifications_notification', 'title')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Notification.title'
        raise RuntimeError("Cannot reverse this migration. 'Notification.title' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Notification.title'
        db.add_column(u'notifications_notification', 'title',
                      self.gf('django.db.models.fields.CharField')(max_length=255),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Notification.content'
        raise RuntimeError("Cannot reverse this migration. 'Notification.content' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Notification.content'
