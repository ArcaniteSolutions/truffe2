...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TruffeUser.is_betatester'
        db.add_column(u'users_truffeuser', 'is_betatester',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TruffeUser.is_betatester'
        db.delete_column(u'users_truffeuser', 'is_betatester')
