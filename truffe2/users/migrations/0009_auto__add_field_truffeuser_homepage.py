...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TruffeUser.homepage'
        db.add_column(u'users_truffeuser', 'homepage',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TruffeUser.homepage'
        db.delete_column(u'users_truffeuser', 'homepage')
