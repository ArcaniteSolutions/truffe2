...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BudgetViews'
        db.create_table(u'accounting_main_budgetviews', (
            ...
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='views', to=orm['accounting_main.Budget'])),
        ))
        db.send_create_signal(u'accounting_main', ['BudgetViews'])

        # Adding model 'AccountingErrorViews'
        db.create_table(u'accounting_main_accountingerrorviews', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('who', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.TruffeUser'])),
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='views', to=orm['accounting_main.AccountingError'])),
        ))
        db.send_create_signal(u'accounting_main', ['AccountingErrorViews'])

        # Adding model 'AccountingLineViews'
        db.create_table(u'accounting_main_accountinglineviews', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('who', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.TruffeUser'])),
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='views', to=orm['accounting_main.AccountingLine'])),
        ))
        db.send_create_signal(u'accounting_main', ['AccountingLineViews'])


    def backwards(self, orm):
        # Deleting model 'BudgetViews'
        db.delete_table(u'accounting_main_budgetviews')

        # Deleting model 'AccountingErrorViews'
        db.delete_table(u'accounting_main_accountingerrorviews')

        # Deleting model 'AccountingLineViews'
        db.delete_table(u'accounting_main_accountinglineviews')
    ...
    models = {
        ...
        u'accounting_main.accountingerrorviews': {
            'Meta': {'object_name': 'AccountingErrorViews'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'views'", 'to': u"orm['accounting_main.AccountingError']"}),
            'when': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'who': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.TruffeUser']"})
        },
        ...
        u'accounting_main.accountinglineviews': {
            'Meta': {'object_name': 'AccountingLineViews'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'views'", 'to': u"orm['accounting_main.AccountingLine']"}),
            'when': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'who': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.TruffeUser']"})
        },
        ...
        u'accounting_main.budgettag': {
            'Meta': {'object_name': 'BudgetTag'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tags'", 'to': u"orm['accounting_main.Budget']"}),
            'tag': ('django.db.models.fields.CharField', [], {'max_length': '255'})
        },
        u'accounting_main.budgetviews': {
            'Meta': {'object_name': 'BudgetViews'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'object': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'views'", 'to': u"orm['accounting_main.Budget']"}),
            'when': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'who': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.TruffeUser']"})
        },
        u'auth.group': {
