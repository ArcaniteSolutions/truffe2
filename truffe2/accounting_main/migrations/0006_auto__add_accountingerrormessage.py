...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AccountingErrorMessage'
        db.create_table(u'accounting_main_accountingerrormessage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.TruffeUser'])),
            ('when', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('message', self.gf('django.db.models.fields.TextField')()),
            ('error', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounting_main.AccountingError'])),
        ))
        db.send_create_signal(u'accounting_main', ['AccountingErrorMessage'])


    def backwards(self, orm):
        # Deleting model 'AccountingErrorMessage'
        db.delete_table(u'accounting_main_accountingerrormessage')
    ...
    models = {
        ...
        u'accounting_main.accountingerror': {
            ...
            'linked_line_text': ('django.db.models.fields.CharField', [], {'max_length': '4096'}),
