...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AccountingError.linked_line_text'
        db.delete_column(u'accounting_main_accountingerror', 'linked_line_text')

        # Adding field 'AccountingError.linked_line_cache'
        db.add_column(u'accounting_main_accountingerror', 'linked_line_cache',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4096),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AccountingError.linked_line_text'
        db.add_column(u'accounting_main_accountingerror', 'linked_line_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4096),
                      keep_default=False)

        # Deleting field 'AccountingError.linked_line_cache'
        db.delete_column(u'accounting_main_accountingerror', 'linked_line_cache')
