...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AccountingLine.unit'
        db.delete_column(u'accounting_main_accountingline', 'unit_id')

        # Deleting field 'AccountingError.unit'
        db.delete_column(u'accounting_main_accountingerror', 'unit_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'AccountingLine.unit'
        raise RuntimeError("Cannot reverse this migration. 'AccountingLine.unit' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'AccountingLine.unit'
        db.add_column(u'accounting_main_accountingline', 'unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['units.Unit']),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'AccountingError.unit'
        raise RuntimeError("Cannot reverse this migration. 'AccountingError.unit' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'AccountingError.unit'
        db.add_column(u'accounting_main_accountingerror', 'unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['units.Unit']),
                      keep_default=False)
