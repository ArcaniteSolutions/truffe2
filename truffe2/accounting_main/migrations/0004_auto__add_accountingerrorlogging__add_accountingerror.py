...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AccountingErrorLogging'
        db.create_table(u'accounting_main_accountingerrorlogging', (
            ...
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='logs', to=orm['accounting_main.AccountingError'])),
        ))
        db.send_create_signal(u'accounting_main', ['AccountingErrorLogging'])

        # Adding model 'AccountingError'
        db.create_table(u'accounting_main_accountingerror', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('linked_line_text', self.gf('django.db.models.fields.CharField')(max_length=4096)),
            ('initial_remark', self.gf('django.db.models.fields.TextField')()),
            ('status', self.gf('django.db.models.fields.CharField')(default='0_drafting', max_length=255)),
            ...
            ('linked_line', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounting_main.AccountingLine'], null=True, blank=True)),
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['units.Unit'])),
        ))
        db.send_create_signal(u'accounting_main', ['AccountingError'])


    def backwards(self, orm):
        # Deleting model 'AccountingErrorLogging'
        db.delete_table(u'accounting_main_accountingerrorlogging')

        # Deleting model 'AccountingError'
        db.delete_table(u'accounting_main_accountingerror')
