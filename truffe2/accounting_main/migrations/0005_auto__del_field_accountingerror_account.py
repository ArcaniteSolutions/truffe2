...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AccountingError.account'
        db.delete_column(u'accounting_main_accountingerror', 'account_id')


    def backwards(self, orm):
        # Adding field 'AccountingError.account'
        db.add_column(u'accounting_main_accountingerror', 'account',
