...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccountingLine.order'
        db.add_column(u'accounting_main_accountingline', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AccountingLine.order'
        db.delete_column(u'accounting_main_accountingline', 'order')
