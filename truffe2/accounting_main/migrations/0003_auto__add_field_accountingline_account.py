...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccountingLine.account'
        db.add_column(u'accounting_main_accountingline', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['accounting_core.Account']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AccountingLine.account'
        db.delete_column(u'accounting_main_accountingline', 'account_id')
