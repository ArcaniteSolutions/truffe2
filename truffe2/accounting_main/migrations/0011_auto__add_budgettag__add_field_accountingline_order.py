...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BudgetTag'
        db.create_table(u'accounting_main_budgettag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('object', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tags', to=orm['accounting_main.Budget'])),
        ))
        db.send_create_signal(u'accounting_main', ['BudgetTag'])

    def backwards(self, orm):
        # Deleting model 'BudgetTag'
        db.delete_table(u'accounting_main_budgettag')
