...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AccountingLine.document_id'
        db.add_column(u'accounting_main_accountingline', 'document_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AccountingLine.document_id'
        db.delete_column(u'accounting_main_accountingline', 'document_id')
